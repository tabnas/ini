...
//
// libtabnasini is the ini format parser as a C shared library, one of
...
import (
	...
	plug "github.com/tabnas/ini/go"
)

const (
	templateVersion = "v1"
	libName         = "libtabnasini"
	formatName      = "ini"
	valueOut        = true
)
...
// newParser builds one engine with the ini grammar installed
...
// parseWith answers whether src is in the ini language — and,
