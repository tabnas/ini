 ...
 * need no network and cannot silently skip, and it is why the manifest's
 * `generatedBy` field names this file: this is the tool that lets anyone
 * re-derive and audit it. At the pins below, a clean re-run reproduces the
 * committed manifest byte for byte; any other diff needs an explanation.
 *
 * ---------------------------------------------------------------------
